        ...
        <section style=" height:30rem; background-color: #50545F ; border-top-right-radius: 1rem!important; border-bottom-right-radius: 1rem!important;" class="otherhalf"> 
            ...
            <form id="LogIn" action="config/script.php" method="POST" class="" data-parsley-validate>
                ...
                <div class="mx-5">
				    ...
				    <input style="background:none;"data-parsley-minlength="3" data-parsley-trigger="keyup"  data-parsley-minlength-message="aint valid..." class="form-control border border-white border-1 rounded " type="text" name="userName"  class="form-control" id="userNAme" required>
		        </div>  
                <div class="m-5">

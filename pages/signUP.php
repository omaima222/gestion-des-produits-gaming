        ...
        <section style="width: 400px;  height:480px; background-color: #50545F ; border-top-right-radius: 1rem!important; border-bottom-right-radius: 1rem!important;" class="py-4"> 
            ...
            <form id="signUp" action="../config/script.php" method="POST" class="" >
                <div class="mx-5">
				    ...
				    <input style="background-color: #50545F;" class="form-control border border-white border-1 rounded " type="text" name="SuserName"  class="form-control" id="userNAme" required>
		        </div>  
                <div class="mx-5 my-3">
					<label for="EMAIL" class="col-form-label text-white fw-light">EMAIL</label>
				    <input style="background-color: #50545F;" class="form-control border border-white border-1 rounded " type="email" name="Semail"  class="form-control" id="email" required>
		        </div>  
                <div class=" mx-5 my-3">
					<label for="PASSWORD" class="col-form-label text-white fw-light">PASSWORD</label>
				    <input style="background-color: #50545F;" class="form-control border border-white border-1 rounded " type="password" name="Spassword"  class="form-control" id="password" required>
		        </div>  
